        ...
        with open(log_path, "r") as log:
            for line in log:
                if "updating customer" in line.lower():
                    # Extract name and email from line
                    ...
                    if match:
                        ...
                        if name_lower in extracted_name_lower.replace(" ", ""):
                            proper_name = extracted_name
    ...
    for file in source_files:
        if "photo-" in file.lower():
            ...
            if uuid and timestamp:
                ...
                import_folder = f"import-{uuid}-video-202411291203-{uuid}"  # Replace with actual extraction logic
