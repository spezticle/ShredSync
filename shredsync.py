...
def main():
	...
	umask_value = config.get("umask", "022")  # Default to 022 if umask is not specified
	...
	try:
		...
		logging.info(f"Folders to process: {len(folders)} found.")
		...
		for folder, mod_time in folders:
			try:
				...
				logging.info(f"Finished syncing folder: {folder}")
